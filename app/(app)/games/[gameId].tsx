...
import BalloonPopGame from '../../../src/games/balloon-pop/BalloonPopGame';
import AnimalSoundsGame from '../../../src/games/animal-sounds/AnimalSoundsGame';
import CountTapGame from '../../../src/games/count-tap/CountTapGame';
...
export default function GameScreen() {
  ...
  switch (gameId) {
    // Premium worlds
    case 'milos-color-world':
      return <MilosColorWorldScreen />;
    case 'milos-puzzle':
      return <MilosPuzzleAdventureScreen />;
    case 'tiny-town':
      return <TinyTownGame />;
    case 'builder-buddies':
      return <BuilderBuddiesGame />;
    case 'happy-pet-home':
      return <HappyPetHomeScreen />;
    case 'milos-quest':
      return <MilosQuestIsland />;
    case 'little-chef':
      return <LittleChefCafe />;
    case 'milos-busy-day':
      return <MilosBusyDayScreen />;
    case 'little-champs':
      return <LittleChampsArenaScreen />;
